...
selected_features = data.columns[np.argsort(feature_importances)[::-1][:1000]]  # 选择前20个重要特征
x_train = x_train[selected_features]
x_test = x_test[selected_features]

# x_test.to_csv("ESM_RF_test.csv", index=False)
# y_test.to_csv("ESM_RFy_test.csv", index=False)
# # 定义模型
...
# joblib.dump(model, 'ESM-RF-S.joblib')
# 预测
