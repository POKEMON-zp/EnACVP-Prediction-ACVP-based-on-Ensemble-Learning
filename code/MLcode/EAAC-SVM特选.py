...
selected_features = data.columns[np.argsort(feature_importances)[::-1][:800]]  # 选择前20个重要特征
x_train = x_train[selected_features]
x_test = x_test[selected_features]

# x_test.to_csv("EAAC_SVM_test.csv", index=False)
# y_test.to_csv("EAAC_SVMy_test.csv", index=False)
# # 建立模型
...
# joblib.dump(model, 'EAAC-SVM-S.joblib')
# 预测
