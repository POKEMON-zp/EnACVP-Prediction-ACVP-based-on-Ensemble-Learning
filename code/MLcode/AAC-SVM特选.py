...
selected_features = data.columns[np.argsort(feature_importances)[::-1][:19]]  # 选择前20个重要特征
x_train = x_train[selected_features]
x_test = x_test[selected_features]

# x_test.to_csv("AAC_SVMx_test.csv", index=False)
# y_test.to_csv("AAC_SVMy_test.csv", index=False)
...
# joblib.dump(model, 'AAC-SVM-S.joblib')
# 预测
