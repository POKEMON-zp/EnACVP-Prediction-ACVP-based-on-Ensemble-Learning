...
selected_features = data.columns[np.argsort(feature_importances)[::-1][:1200]]  # 选择前20个重要特征
x_train = x_train[selected_features]
x_test = x_test[selected_features]

# x_test.to_csv("EAAC_RF_test.csv", index=False)
# y_test.to_csv("EAAC_RFy_test.csv", index=False)
# # 定义模型
...
# #保存模型
#
# # joblib.dump(model, 'EAAC-RF-S.joblib')
# # 预测
