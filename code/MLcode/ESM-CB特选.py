...
selected_features = data.columns[np.argsort(feature_importances)[::-1][:900]]  # 选择前20个重要特征
...
# # 定义超参数网格
# param_grid = {
#     'learning_rate':np.arange(0.04,0.15,0.01),
...
# #     'learning_rate':[0.13],
# #     'depth':[10],
# #     'iterations':np.arange(100,900,100)
# # }
# # 定义网格搜索对象
...
# #保存模型
joblib.dump(model, 'ESM-CB-1.joblib')
# # 预测
